...
@Transactional
public class OnboardingLanguageServiceImpl implements OnboardingLanguageService {
    ...
    public void saveLanguageLevel(UUID userId, LanguageLevelRequest req) {
        ...
        for (LanguageLevelRequest.LanguageLevelDto dto : req.languages()) {
            ...
            OnboardingLangLevelId id = new OnboardingLangLevelId(userId, dto.languageId());
            ...
            OnboardingLangLevel onboardLangLevel = OnboardingLangLevel.builder()
                    .id(id)
                    .langLevelType(currentLevelType) // 기존 호환성 유지
                    .currentLevel(currentLevelType)
                    .targetLevel(targetLevelType)
                    .build();
            onboardingLangLevelRepository.save(onboardLangLevel);
            System.out.println("🔍 Saved onboarding lang level for language ID: " + dto.languageId());
        }
