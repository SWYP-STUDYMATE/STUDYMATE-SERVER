...
INSERT INTO LEARNING_EXPECTATION (LEARNING_EXPECTATION_NAME) VALUES ('매일 조금씩이라도 꾸준히 이어갈 수 있는 습관');
INSERT INTO LEARNING_EXPECTATION (LEARNING_EXPECTATION_NAME) VALUES ('당당하게 대화할 수 있는 자신감');
INSERT INTO LEARNING_EXPECTATION (LEARNING_EXPECTATION_NAME) VALUES ('나에게 맞는 속도와 방식');
INSERT INTO LEARNING_EXPECTATION (LEARNING_EXPECTATION_NAME) VALUES ('실전 상황에서도 바로 쓸 수 있는 회화력');
